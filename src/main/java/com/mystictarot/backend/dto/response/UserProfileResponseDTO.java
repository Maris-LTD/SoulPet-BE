...
@AllArgsConstructor
@Builder
@Schema(description = "Response DTO containing user profile information and usage statistics")
public class UserProfileResponseDTO {
    ...
    @Schema(description = "Number of readings used in current week", example = "2")
    private Integer weeklyReadingsUsed;

    @Schema(description = "Weekly readings limit based on plan (-1 for unlimited)", example = "3")
    private Integer weeklyReadingsLimit;

    @Schema(description = "Total number of active readings", example = "15")
